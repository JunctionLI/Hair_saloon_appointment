class Appointment:
    ...
    def get_end_time_hour(self):
        self.end_time_hour=int(self.start_time_hour)+1
...
#set information from clients
    ...
    def __str__(self):
        return f"{self.client_name:20}{self.client_phone:15}{self.day_of_week:10}{self.start_time_hour:2}:00  -  {self.get_end_time_hour()}:00     {self.get_appt_type_desc():20}"
